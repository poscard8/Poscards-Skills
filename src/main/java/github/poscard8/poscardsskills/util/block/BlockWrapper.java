...
public class BlockWrapper implements Supplier<Block>, ItemLike
{
    ...
    public void addBlockModel(BlockStateProvider provider)
    {
        if (isIncluded()) blockType.blockModelFunction.accept(provider, this);
    }
    ...
    public boolean isIncluded() { return !isExcluded(); }

    public boolean isExcluded() { return excluded; }

    public BlockWrapper exclude()
    {
        excluded = true;
        return this;
    }
