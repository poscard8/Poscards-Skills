...
public enum BlockType {
    ...
    static void blockLoot(BlockLoot provider, BlockWrapper wrapper) { provider.dropSelf(wrapper.get()); }

    static void slabLoot(BlockLoot provider, BlockWrapper wrapper) { ((PSLootTableProvider.Sub) provider).slab(wrapper.get()); }
