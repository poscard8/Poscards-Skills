...
public class CatalystItem extends ItemWithDescription {
    ...
    protected LootTable getLootTable(ServerPlayer player) {
        ...
        LootTable lootTableA = Objects.requireNonNull(player.getServer()).getLootTables().get(lootTableKeyA);
        LootTable lootTableB = Objects.requireNonNull(player.getServer()).getLootTables().get(lootTableKeyB);
