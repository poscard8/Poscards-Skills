...
public class SecretArgumentType implements ArgumentType<String> {
    ...
    private static final SimpleCommandExceptionType NO_SECRET_FOUND = new SimpleCommandExceptionType(Component.translatable("command.poscardsskills.no_secret_found"));
