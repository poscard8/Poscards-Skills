 ...
 * See {@code "data/github.poscard8.poscardsskills/tags/items/magic_shards.json"} for magic shard items.
 */
...
public class CarryMagicShardTrigger extends SimpleCriterionTrigger<CarryMagicShardTrigger.TriggerInstance> {
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public TriggerInstance(EntityPredicate.Composite predicate, int count) {
