...
public class RuneCraftingClearRecipe extends CustomRecipe
{
    public RuneCraftingClearRecipe(ResourceLocation key, CraftingBookCategory category) { super(key, category); }
    ...
    public boolean matches(CraftingContainer container, Level level)
    {
        ...
        for (ItemStack stack : container.getItems())
        {
            ...
            if (stack.is(PSTags.Items.EMPTY_RUNES)) runeCount++;
    ...
    public ItemStack assemble(CraftingContainer container, RegistryAccess registryAccess)
    {
        ...
        for (ItemStack stack : container.getItems())
        {
            if (rune.isEmpty() && stack.is(PSTags.Items.EMPTY_RUNES)) rune = stack.copy();
        ...
        ColorGradient.removeFromItem(item);
        item.setCount(1);
        return item;
    }
    ...
    @Override
    public RecipeSerializer<?> getSerializer() { return PSRecipeSerializers.RUNE_CRAFTING_CLEAR.get(); }
