...
public class AscensionCategory implements IRecipeCategory<Ascension> {
     ...
     */
    @Override
    public void draw(Ascension recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        guiGraphics.drawString(font, line1, x1, y1, 0, false);
        guiGraphics.drawString(font, line2, x2, y2, 0, false);
    }
