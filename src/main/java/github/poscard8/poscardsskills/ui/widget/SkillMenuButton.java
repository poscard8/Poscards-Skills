...
public class SkillMenuButton extends ButtonWithTooltip {
    ...
    public SkillMenuButton(SkillInstance instance, int x, int y) {

        super(x, y, 18, 18, 176, 0, 18, PoscardsSkillsScreen.TEXTURE_LOCATION, 256, 256, press(instance), () -> PSComponents.skillInstanceComponents(instance));
    ...
    public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
        ...
        if (instance.hasUnclaimedRewards()) {
            ...
            minecraft.font.drawInBatch(component, getX() + 18 - minecraft.font.width(component), getY(), color, true, pose.last().pose(), buffersource, Font.DisplayMode.NORMAL, 0, 15728880);
