...
public final class Skill implements Comparable<Skill> {
    ...
    public static final String
        ...
        WOODCUTTING_KEY_STRING = "poscardsskills:woodcutting",
        MINING_KEY_STRING = "poscardsskills:mining",
        FARMING_KEY_STRING = "poscardsskills:farming",
        COMBAT_KEY_STRING = "poscardsskills:combat",
        EXPLORING_KEY_STRING = "poscardsskills:exploring",
        ENCHANTING_KEY_STRING = "poscardsskills:enchanting";
