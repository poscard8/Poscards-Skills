...
public final class PoscardsSkills {
    ...
    void setAttributeStyles() {
        ...
        getComponentHandler()
                ...
                .setAttributeStyle(ForgeMod.BLOCK_REACH, new AttributeStyle(ChatFormatting.BLUE, "⛏"))
                .setAttributeStyle(ForgeMod.ENTITY_REACH, new AttributeStyle(ChatFormatting.GOLD, "⚔"))
